...
| **패키지 검증** | `CoinService`는 `COIN_PACKAGES` Map에서 `packageId`(1-10)가 **유효한지** 확인하고, 요청한 **coinAmount와 paymentAmount가 패키지 정보와 일치하는지** 검증합니다. | **패키지 정보 검증** (예외 처리) |
...
| 7 | 50,000 | 444,000원 |
| 8 | 100,000 | 864,000원 |
| 9 | 300,000 | 2,592,000원 |
| 10 | 500,000 | 4,320,000원 |
